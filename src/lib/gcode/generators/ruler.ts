...
function x_zig(xstart: number, xend: number, ymid: number, zup: string, zdn: string, rapid: number, vertical: number, drawspeed: number): string {
  let out = ''
...
function x_zag(xstart: number, xend: number, ymid: number, zup: string, zdn: string, rapid: number, vertical: number, drawspeed: number): string {
  let out = ''
...
function y_zig(xmid: number, ystart: number, yend: number, zup: string, zdn: string, rapid: number, vertical: number, drawspeed: number): string {
  let out = ''
...
function y_zag(xmid: number, ystart: number, yend: number, zup: string, zdn: string, rapid: number, vertical: number, drawspeed: number): string {
  let out = ''
